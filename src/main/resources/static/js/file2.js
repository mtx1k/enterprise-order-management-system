...
!(function (e, t) {
    ...
    function P(e) {
        return (
            ...
            ((Se = window),
                ...
                (Me = k.isTouch = Se.matchMedia && Se.matchMedia("(hover: none), (pointer: coarse)").matches ? 1 : "ontouchstart" in Se || 0 < navigator.maxTouchPoints || 0 < navigator.msMaxTouchPoints ? 2 : 0),
                (Be = k.eventTypes = ("ontouchstart" in Ee ? "touchstart,touchmove,touchcancel,touchend" : "onpointerdown" in Ee ? "pointerdown,pointermove,pointercancel,pointerup" : "mousedown,mousemove,mouseup,mouseup").split(",")),
                setTimeout(function () {
                    return (i = 0);
                }, 500),
                O(),
    ...
    var k =
        ((Observer.prototype.init = function init(e) {
            ...
            function ff() {
                ...
                (ne || re) && (q && q(se), re && (p && 1 === re && p(se), h && h(se), (re = 0)), (ne = !1)),
                oe && !(oe = !1) && $ && $(se),
                ie && (X(se), (ie = !1)),
                    (ee = 0);
            }
            ...
            function of(e) {
                if (!df(e)) {
                    var t = fe(),
                        r = de();
                    gf((t - pe) * G, (r - ge) * G, 1), (pe = t), (ge = r), l && te.restart(!0);
                }
            }
            function pf(e) {
                if (!df(e)) {
            ...
            var ee,
                ...
                pe = fe(),
                ge = de(),
                he = ~t.indexOf("touch") && !~t.indexOf("pointer") && "pointerdown" === Be[0],
                ve = A(o),
            ...
            (te = se._dc = Te.delayedCall(c || 0.25, function onStopFunc() {
                ...
                (se.disable = function () {
                    ...
                    se.isPressed && (se._vx.reset(), se._vy.reset(), C(Y ? o : be, Be[1], jf, !0)),
    ...
    function Db(e, t, r, n, i, o, a, s) {
        ...
        return (
            ...
            (!h && !s && g) || (y += (n === ze ? q : I) + ":" + (o + parseFloat(f)) + "px;"),
    ...
    function Lb(e) {
        qe.cache++, (!0 !== e && (Ke || h || Xe.fullscreenElement || Xe.webkitFullscreenElement || (b && y === Ne.innerWidth && !(Math.abs(Ne.innerHeight - m) > 0.25 * Ne.innerHeight)))) || c.restart(!0);
    }
    function Ob() {
    ...
    var He,
        ...
        Et = function _refreshAll(e, t) {
            if (((We = Xe.documentElement), (Je = Xe.body), (l = [Ne, Xe, We, Je]), !st || e || S)) {
                Yb(),
        ...
        Z = function _updateAll(e) {
            if (2 === e || (!rt && !S)) {
                ...
                var t = Ct.length,
                    ...
                    n = 50 <= r - R,
                    i = t && Ct[0].scroll();
                if (((Pt = i < Q ? -1 : 1), rt || (Q = i), n && (st && !je && 200 < r - st && ((st = 0), U("scrollEnd")), (Ge = R), (R = r)), Pt < 0)) {
            ...
            ((ScrollTrigger.prototype.init = function init(M, O) {
                if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), lt)) {
                    var A,
                        ...
                        T,
                        o,
                        C = (M = ob(ct(M) || Ua(M) || M.nodeType ? { trigger: M } : M, Tt)).onUpdate,
                        S = M.toggleClass,
                        a = M.id,
                        k = M.onToggle,
                        ie = M.onRefresh,
                        ...
                        he = M.horizontal || (M.containerAnimation && !1 !== M.horizontal) ? Fe : ze,
                        ve = !E && 0 !== E,
                        be = J(M.scroller || Ne),
                    ...
                    if (
                        ((Ce._startClamp = Ce._endClamp = !1),
                            ...
                            (Ce.vars = M),
                            (O = O || M.animation),
                        "refreshPriority" in M && ((Ze = 1), -9999 === M.refreshPriority && (it = Ce)),
                            (c.tweenScroll = c.tweenScroll || { top: rc(be, ze), left: rc(be, Fe) }),
                        ...
                        O &&
                        ((O.vars.lazy = !1),
                        (O._initted && !Ce.isReverted) || (!1 !== O.vars.immediateRender && !1 !== M.immediateRender && O.duration() && O.render(0, !0, !0)),
                        ...
                        "scrollBehavior" in Je.style && He.set(me ? [Je, We] : be, { scrollBehavior: "auto" }),
                            qe.forEach(function (e) {
                            ...
                            (te = He.delayedCall(ue.delay || i / 2 || 0.1, function () {
                                var e = Ae(),
                                    t = at() - Me < 500,
                                    r = A.tween;
                                if (!(t || Math.abs(Ce.getVelocity()) < 10) || r || je || Pe === e) Ce.isActive && Pe !== e && te.restart(!0);
                                else {
                                    var n,
                                        i,
                                        o = (e - R) / N,
                                        ...
                                        f = ue.onInterrupt,
                                        d = ue.onComplete;
                                    if (((n = p(c, Ce)), Ua(n) || (n = c), (i = Math.max(0, Math.round(R + n * N))), e <= L && R <= e && i !== e)) {
                                                ...
                                                i,
                                                {
                                                    ...
                                                    onComplete: function onComplete() {
                                                        ...
                                                        O && !ve && (ee ? ee.resetTo("totalProgress", n, O._tTime / O._tDur) : O.progress(n)),
                                                            (w = _ = O && !ve ? O.totalProgress() : Ce.progress),
                                                        h && h(Ce),
                                                        d && d(Ce);
                                                    },
                                                },
                        ...
                        (e = Va(_e) ? ob(_e, _t) : _t), (Y = Db("", a, be, he, e, 0)), (F = Db("", a, be, he, e, 0, Y)), (t = Y["offset" + he.op.d2]);
                        var u = J(z(be, "content") || be);
                        (q = this.markerStart = Db("", a, u, he, e, t, 0, de)),
                            (I = this.markerEnd = Db("", a, u, he, e, t, 0, de)),
                    ...
                    if (
                        ((Ce.previous = function () {
                                ...
                                if ((!Ke && Ce.enabled) || t)
                                    if (ae && e && st) wb(ScrollTrigger, "scrollEnd", Ob);
                                        ...
                                        var i,
                                            ...
                                            P = E;
                                        for (_e && Va(r) && ((h = He.getProperty(Y, he.p)), (v = He.getProperty(F, he.p))); 0 < P--; )
                                            (c = Ct[P]).end || c.refresh(0, 1) || (Ke = Ce), !(u = c.pin) || (u !== oe && u !== ae && u !== k) || c.isReverted || ((p = p || []).unshift(c), c.revert(!0, !0)), c !== Ct[P] && (E--, P--);
                                        for (
                                            Ta(S) && (S = S(Ce)),
                                                S = Ca(S, "start", Ce),
                                                R = mc(S, oe, b, he, Ae(), q, Y, Ce, m, Te, ye, y, de, Ce._startClamp && "_startClamp") || (ae ? -0.001 : 0),
                                            Ta(T) && (T = T(Ce)),
                                            ct(T) &&
                                            !T.indexOf("+=") &&
                                            (~T.indexOf(" ")
                                                ? (T = (ct(S) ? S.split(" ")[0] : "") + T)
                                                : ((w = Cb(T.substr(2), b)), (T = ct(S) ? S : (de ? He.utils.mapRange(0, de.duration(), de.scrollTrigger.start, de.scrollTrigger.end, R) : R) + w), (C = oe))),
                                                T = Ca(T, "end", Ce),
                                                L = Math.max(R, mc(T || (C ? "100% 0" : y), C, b, he, Ae() + w, I, F, Ce, m, Te, ye, y, de, Ce._endClamp && "_endClamp")) || -0.001,
                                                w = 0,
                                                P = E;
                                            P--;
                                            ...
                                            !de &&
                                            0 < c.end &&
                                            ((i = c.end - (Ce._startClamp ? Math.max(0, c.start) : c.start)), ((u === oe && c.start - c._pinPush < R) || u === k) && isNaN(S) && (w += i * (1 - c.progress)), u === ae && (_ += i));
                                        if (
                                            ((R += w),
                                                (L += w),
                                            Ce._startClamp && (Ce._startClamp += w),
                                            Ce._endClamp && !rt && ((Ce._endClamp = L || -0.001), (L = Math.min(L, Qa(be, he)))),
                                                (N = L - R || ((R -= 0.01) && 0.001)),
                                            x && (Oe = He.utils.clamp(0, 1, He.utils.normalize(R, L, re))),
                                                (Ce._pinPush = _),
                                            q && w && (((i = {})[he.a] = "+=" + w), k && (i[he.p] = "-=" + Ae()), He.set([q, I], i)),
                                            ...
                                            !y &&
                                            1 < L &&
                                            ((g = { style: (g = (me ? Xe.scrollingElement || We : be).style), value: g["overflow" + he.a.toUpperCase()] }),
                                            me && "scroll" !== mb(Je)["overflow" + he.a.toUpperCase()] && (g.style["overflow" + he.a.toUpperCase()] = "scroll")),
                                                gc(ae, U, i),
                                                (V = jc(ae)),
                                                (o = wt(ae, !0)),
                                                (f = ye && K(be, s ? Fe : ze)()),
                                                se
                                                    ...
                                                    (P = se === bt ? qb(ae, he) + N + _ : 0) && (Z.push(he.d, P + xt), "auto" !== U.style.flexBasis && (U.style.flexBasis = P + xt)),
                                                        Mt(Z),
                                                    k &&
                                                    Ct.forEach(function (e) {
                                                    ...
                                                    ye && Ae(re))
                                                    : (P = qb(ae, he)) && "auto" !== U.style.flexBasis && (U.style.flexBasis = P + xt),
                                            ye &&
                                            (((l = { top: o.top + (s ? a - R : f) + xt, left: o.left + (s ? f : a - R) + xt, boxSizing: "border-box", position: "fixed" })[ft] = l.maxWidth = Math.ceil(o.width) + xt),
                                        ...
                                        (x || Oe !== Ce.progress || de || le || (O && !O._initted)) &&
                                        (O && !ve && O.totalProgress(de && R < -0.001 && !Oe ? He.utils.normalize(R, L, 0) : Oe, !0), (Ce.progress = x || (D - R) / N === Oe ? 0 : Oe)),
                                        ae && se && (U._pinOffset = Math.round(Ce.progress * Q)),
                                        ee && ee.invalidate(),
                                        isNaN(h) || ((h -= He.getProperty(Y, he.p)), (v -= He.getProperty(F, he.p)), qc(Y, he, h), qc(q, he, h - (n || 0)), qc(F, he, v), qc(I, he, v - (n || 0))),
                                        x && !rt && Ce.update(),
                            ...
                            (Ce.getTrailing = function (t) {
                                var e = Ct.indexOf(Ce),
                                    r = 0 < Ce.direction ? Ct.slice(0, e).reverse() : Ct.slice(e + 1);
                                return (ct(t)
                                        ? r.filter(function (e) {
                            ...
                            (Ce.update = function (e, t, r) {
                                if (!de || r || e) {
                                    var n,
                                        ...
                                        p = Ce.progress;
                                    if (
                                        (t && ((B = D), (D = de ? Ae() : u), ue && ((_ = w), (w = O && !ve ? O.totalProgress() : d))),
                                        P && ae && !Ke && !ot && st && (!d && R < u + ((u - B) / (at() - Ge)) * P ? (d = 1e-4) : 1 === d && L > u + ((u - B) / (at() - Ge)) * P && (d = 0.9999)),
                                        d !== p && Ce.enabled)
                                    ) {
                                        if (
                                            ((a = (s = (n = Ce.isActive = !!d && d < 1) != (!!p && p < 1)) || !!d != !!p),
                                                (Ce.direction = p < d ? 1 : -1),
                                                (Ce.progress = d),
                                            a && !Ke && ((i = d && !p ? 0 : 1 === d ? 1 : 1 === p ? 2 : 3), ve && ((o = (!s && "none" !== we[i + 1] && we[i + 1]) || we[i]), (c = O && ("complete" === o || "reset" === o || o in O)))),
                                            ge &&
                                            (s || c) &&
                                            (c || E || !O) &&
                                            (Ta(ge)
                                            ...
                                            if ((e && se && (U.style[se + he.os2] = m), ye)) {
                                                if (a) {
                                                    if (((l = !e && p < d && u < L + 1 && u + 1 >= Qa(be, he)), fe))
                                                        if (e || (!n && !l)) oc(ae, U);
                                                        else {
                                                            var g = wt(ae, !0),
                                                                h = u - R;
                                        ...
                                        !C || ve || e || C(Ce),
                                            a && !Ke
                                                ? (ve && (c && ("complete" === o ? O.pause().totalProgress(1) : "reset" === o ? O.restart(!0).pause() : "restart" === o ? O.restart(!0) : O[o]()), C && C(Ce)),
                                                (!s && tt) || (k && s && Xa(Ce, k), xe[i] && Xa(Ce, xe[i]), ce && (1 === d ? Ce.kill(!1, 1) : (xe[i] = 0)), s || (xe[(i = 1 === d ? 1 : 3)] && Xa(Ce, xe[i]))),
                                                pe && !n && Math.abs(Ce.getVelocity()) > (Ua(pe) ? pe : 2500) && (Wa(Ce.callbackAnimation), ee ? ee.progress(1) : Wa(O, "reverse" === o ? 1 : !d, 1)))
                                                : ve && C && !Ke && C(Ce);
                                    }
                                    if (x) {
                            ...
                            (Ce.enable = function (e, t) {
                                Ce.enabled ||
                                ((Ce.enabled = !0), wb(be, "resize", Lb), me || wb(be, "scroll", Jb), Se && wb(ScrollTrigger, "refreshInit", Se), !1 !== e && ((Ce.progress = Oe = 0), (D = B = Pe = Ae())), !1 !== t && Ce.refresh());
                            }),
                            ...
                            (Ce.setPositions = function (e, t, r, n) {
                                ...
                                Ce.refresh(!1, !1, { start: Da(e, r && !!Ce._startClamp), end: Da(t, r && !!Ce._endClamp) }, n), Ce.update();
                            }),
                ...
                (e.onRelease = e.onGestureStart = function (e, t) {
                    if ((b.offset && Fq(), t)) {
                        ...
                        var r,
                            n,
                            i = _();
                        f && ((n = (r = m()) + (0.05 * i * -e.velocityX) / 0.227), (i *= tc(m, r, n, Qa(p, Fe))), (a.vars.scrollX = C(n))),
                            (n = (r = b()) + (0.05 * i * -e.velocityY) / 0.227),
                            (i *= tc(b, r, n, Qa(p, ze))),
                            (a.vars.scrollY = S(n)),
                            a.invalidate().duration(i).play(0.01),
                        ((E && a.vars.scrollY >= o) || o - 1 <= r) && He.to({}, { onUpdate: Lq, duration: i });
                    } else s.restart(!0);
                    d && d(e);
                }),
                (e.onWheel = function () {
