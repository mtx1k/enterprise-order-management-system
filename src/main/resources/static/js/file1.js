...
!(function (t, e) {
    ...
    function Ja(t, e) {
        var r;
        if (
            ((e._time || (!e._dur && e._initted) || (e._start < t._time && (e._dur || !e.add))) && ((r = Ga(t.rawTime(), e)), (!e._dur || kt(0, e.totalDuration(), r) - e._tTime > X) && e.render(r, !0)),
                    ...
                    ? [
                        (function _parseObjectInString(t) {
                            for (var e, r, i, n = {}, a = t.substr(1, t.length - 3).split(":"), s = a[0], o = 1, u = a.length; o < u; o++)
                                (r = a[o]), (e = o !== u - 1 ? r.lastIndexOf(",") : r.length), (i = r.substr(0, e)), (n[s] = isNaN(i) ? i.replace(Yt, "").trim() : +i), (s = r.substr(e + 1).trim());
                            return n;
                        })(e[1]),
                    ]
    ...
    function gn(t) {
        return t < j ? B * t * t : t < 0.7272727272727273 ? B * Math.pow(t - 1.5 / 2.75, 2) + 0.75 : t < 0.9090909090909092 ? B * (t -= 2.25 / 2.75) * t + 0.9375 : B * Math.pow(t - 2.625 / 2.75, 2) + 0.984375;
    }
        ...
        return (
            (e.to = function to(t, e, r) {
                ...
                (e.render = function render(t, e, r) {
                    ...
                    if ((this !== I && m < v && 0 <= t && (v = m), v !== this._tTime || r || y)) {
                        if ((_ !== this._time && g && ((v += this._time - _), (t += this._time - _)), (i = v), (f = this._start), (u = !(l = this._ts)), y && (g || (_ = this._zTime), (!t && e) || (this._zTime = t)), this._repeat)) {
                            ...
                            if (
                                ((i = ja(v % o)),
                                    v === m ? ((s = this._repeat), (i = g)) : ((s = ~~(d = ja(v / o))) && s === d && ((i = g), s--), g < i && (i = g)),
                                    (d = Tt(this._tTime, o)),
                ...
                (e.remove = function remove(t) {
                    return r(t) ? this.removeLabel(t) : s(t) ? this.killTweensOf(t) : (t.parent === this && ya(this, t), t === this._recent && (this._recent = this._last), Aa(this));
                }),
    ...
    var $t = (function (D) {
        function Tween(e, r, i, n) {
            ...
            if (((a._targets = C.length ? ea(C) : R("GSAP target " + e + " not found. https://gsap.com", !q.nullTargetWarn) || []), (a._ptLookup = []), (a._overwrite = b), x || T || y(_) || y(m))) {
                if (
                    ((r = a.vars),
                        (s = a.timeline = new Xt({ data: "nested", defaults: k || {}, targets: P && "nested" === P.data ? P.vars.targets : C })).kill(),
                ...
                if (p) {
                    if (m !== this._tTime || !t || r || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 != _) || this._lazy) {
                        if (((i = m), (l = this.timeline), this._repeat)) {
                            ...
                            if (
                                ((i = ja(m % s)),
                                    m === c ? ((a = this._repeat), (i = p)) : (a = ~~(o = ja(m / s))) && a === o ? ((i = p), a--) : p < i && (i = p),
    ...
    function Ld() {
        ...
        for (t = 0; t < r.length; t += 3)
            r[t + 1] ? (2 === r[t + 1] ? i[r[t]](r[t + 2]) : (i[r[t]] = r[t + 2])) : r[t + 2] ? (n[r[t]] = r[t + 2]) : n.removeProperty("--" === r[t].substr(0, 2) ? r[t] : r[t].replace(hr, "-$1").toLowerCase());
        if (this.tfm) {
            for (e in this.tfm) a[e] = this.tfm[e];
            a.svg && (a.renderTransform(), i.setAttribute("data-svg-origin", this.svgo || "")),
            ((t = Ye()) && t.isStart) || n[cr] || (Kd(n), a.zOrigin && n[pr] && ((n[pr] += " " + a.zOrigin + "px"), (a.zOrigin = 0), a.renderTransform()), (a.uncache = 1));
        }
    }
    function Md(t, e) {
    ...
    function Vd(e) {
        ...
        return (r && (r.width || r.height)) || i || (r = Td(e)), !r || r.width || r.x || r.y ? r : { x: +Ud(e, ["x", "cx", "x1"]) || 0, y: +Ud(e, ["y", "cy", "y1"]) || 0, width: 0, height: 0 };
    }
    function Wd(t) {
    ...
    function ee(t, e) {
        if (e.tween && e.tween._time === e.tween._dur) {
            ...
            i && (Xd(a, cr), u && (u.svg && a.removeAttribute("transform"), (s.scale = s.rotate = s.translate = "none"), kr(a, 1), (u.uncache = 1), Kd(s)));
        }
    }
    function ie(t) {
    ...
    function ke(t, e) {
        ...
        return s.svg && t.getAttribute("transform")
            ...
            ((n = o.display),
                (o.display = "block"),
            ((r = t.parentNode) && (t.offsetParent || t.getBoundingClientRect().width)) || ((a = 1), (i = t.nextElementSibling), Re.appendChild(t)),
                (u = je(t)),
    ...
    function xe(t, e, r) {
        var i,
            ...
            f = r.style;
        for (n in (l.svg
            ? ((a = r.getAttribute("transform")), r.setAttribute("transform", ""), (f[cr] = e), (i = kr(r, 1)), Xd(r, cr), r.setAttribute("transform", a))
        ...
        yr = function _get(t, e, r, i) {
            ...
            return (
                ...
                e in dr && "transform" !== e && ~(e = dr[e]).indexOf(",") && (e = e.split(",")[0]),
                    ar[e] && "transform" !== e
                        ? ((n = kr(t, i)), (n = "transformOrigin" !== e ? n[e] : n.svg ? n.origin : Or(Pd(t, pr)) + " " + n.zOrigin + "px"))
        ...
        kr = function _parseTransform(t, e) {
            ...
            return (
                ...
                (F[cr] =
                    ...
                    (m = ke(t, r.svg)),
                r.svg && ((M = r.uncache ? ((P = t.getBBox()), (B = r.xOrigin - P.x + "px " + (r.yOrigin - P.y) + "px"), "") : !e && t.getAttribute("data-svg-origin")), le(t, M || B, !!M || r.originIsAbsolute, !1 !== r.smooth, m)),
                    (p = r.xOrigin || 0),
                    (_ = r.yOrigin || 0),
                m !== wr &&
                ((T = m[0]),
